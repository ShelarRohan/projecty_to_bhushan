...
class UserDetailCard extends StatefulWidget {
  ...
  @override
  _UserDetailCardState createState() =>
      _UserDetailCardState(staffid, staffname, staffdob, staffdepartment);
}
...
class _UserDetailCardState extends State<UserDetailCard>
  ...
  _UserDetailCardState(
      this.staffid, this.staffname, this.staffdob, this.staffdepartment);
